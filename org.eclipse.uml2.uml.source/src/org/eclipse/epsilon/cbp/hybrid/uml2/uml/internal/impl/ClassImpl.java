...
import org.eclipse.epsilon.cbp.hybrid.uml2.uml.Reception;
...
import org.eclipse.epsilon.cbp.hybrid.uml2.uml.internal.operations.BehavioredClassifierOperations;
import org.eclipse.epsilon.cbp.hybrid.uml2.uml.internal.operations.ClassOperations;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.internal.impl.ClassImpl#getOwnedElements <em>Owned Element</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.internal.impl.ClassImpl#getOwnedMembers <em>Owned Member</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.internal.impl.ClassImpl#getOwnedBehaviors <em>Owned Behavior</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.internal.impl.ClassImpl#getClassifierBehavior <em>Classifier Behavior</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.internal.impl.ClassImpl#getInterfaceRealizations <em>Interface Realization</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.internal.impl.ClassImpl#getFeatures <em>Feature</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.internal.impl.ClassImpl#getAttributes <em>Attribute</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.internal.impl.ClassImpl#getOwnedOperations <em>Owned Operation</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.internal.impl.ClassImpl#getExtensions <em>Extension</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.internal.impl.ClassImpl#isActive <em>Is Active</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.internal.impl.ClassImpl#getNestedClassifiers <em>Nested Classifier</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.internal.impl.ClassImpl#getOwnedReceptions <em>Owned Reception</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.internal.impl.ClassImpl#getSuperClasses <em>Super Class</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.internal.impl.ClassImpl#getOwnedAttributes <em>Owned Attribute</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.internal.impl.ClassImpl#isAbstract <em>Is Abstract</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClassImpl
		...
		implements org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public EList<org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class> getSuperClasses() {
		CacheAdapter cache = getCacheAdapter();
		if (cache != null) {
			Resource eResource = eResource();
			EList<org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class> superClasses = (EList<org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class>) cache
				.get(eResource, this, UMLPackage.Literals.CLASS__SUPER_CLASS);
			if (superClasses == null) {
				cache.put(eResource, this,
					UMLPackage.Literals.CLASS__SUPER_CLASS,
					superClasses = (EList<org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class>) ((EList<?>) new SuperClassEList(
						org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class.class, this,
						UMLPackage.CLASS__SUPER_CLASS,
						SUPER_CLASS_ESUPERSETS)));
			}
			return superClasses;
		}
		return (EList<org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class>) ((EList<?>) new SuperClassEList(
			org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class.class, this,
	 ...
	 * @generated
	 */
	public org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class getSuperClass(String name) {
	...
	public org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class getSuperClass(String name,
		...
		superClassLoop : for (org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class superClass : getSuperClasses()) {
		...
		switch (featureID) {
			...
			case UMLPackage.CLASS__SUPER_CLASS :
				...
				getSuperClasses().addAll(
					(Collection<? extends org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class>) newValue);
				return;
		}
