 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Profile#validateMetaclassReferenceNotSpecialized(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Metaclass Reference Not Specialized</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Profile#validateReferencesSameMetamodel(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate References Same Metamodel</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Profile#create(org.eclipse.epsilon.cbp.hybrid.uml2.uml.Classifier) <em>Create</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Profile#define() <em>Define</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Profile#define(java.util.Map, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Define</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Profile#getDefinition() <em>Get Definition</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Profile#getDefinition(org.eclipse.epsilon.cbp.hybrid.uml2.uml.NamedElement) <em>Get Definition</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Profile#getOwnedExtensions(boolean) <em>Get Owned Extensions</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Profile#getReferencedMetaclasses() <em>Get Referenced Metaclasses</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Profile#getReferencedMetamodels() <em>Get Referenced Metamodels</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Profile#isDefined() <em>Is Defined</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProfileOperations
	...
	public static boolean validateMetaclassReferenceNotSpecialized(
		...
		for (org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class referencedMetaclass : profile
			...
			for (TreeIterator<EObject> allContents = getAllContents(profile,
				...
				if (eObject instanceof org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package
					&& containsSpecializations(
						(org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package) eObject,
						referencedMetaclass)) {
	...
	protected static ENamedElement getDefinition(Profile profile,
		...
		} else if (namedElement instanceof org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package) {
			ENamedElement packageDefinition = getDefinition(profile,
				((org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package) namedElement)
					.getNestingPackage(),
				profileDefinition);
	 ...
	 * @generated NOT
	 */
	public static EList<org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class> getReferencedMetaclasses(
			Profile profile) {
		EList<org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class> referencedMetaclasses = new UniqueEList.FastCompare<org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class>();
		...
		for (ElementImport metaclassReference : profile
			...
			if (importedElement instanceof org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class) {
				referencedMetaclasses
					.add((org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class) importedElement);
			}
		}
	...
	public static EList<Model> getReferencedMetamodels(Profile profile) {
		...
		for (PackageImport metamodelReference : profile
			...
			org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package importedPackage = metamodelReference
				.getImportedPackage();
