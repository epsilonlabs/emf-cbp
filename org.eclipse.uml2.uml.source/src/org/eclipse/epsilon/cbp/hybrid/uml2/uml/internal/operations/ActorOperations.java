...
import org.eclipse.epsilon.cbp.hybrid.uml2.uml.Actor;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Actor#validateAssociations(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Associations</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Actor#validateMustHaveName(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Must Have Name</em>}</li>
 * </ul>
 *
 * @generated
 */
		...
		for (Association association : actor.getAssociations()) {
			...
			if (result) {
				...
				result &= actorEndType instanceof UseCase
					|| (actorEndType instanceof org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class
