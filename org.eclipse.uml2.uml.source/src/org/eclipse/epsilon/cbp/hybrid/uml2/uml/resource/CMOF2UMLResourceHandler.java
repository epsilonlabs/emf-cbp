		...
		for (int i = 0; i < resourceContents.size(); i++) {
			...
			if (content instanceof AnyType
				...
				if (CMOF2UMLExtendedMetaData.EMOF_TAG__OPPOSITE_ROLE_NAME
					...
					if (element instanceof org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class
					...
					if (element instanceof org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package) {
						org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package package_ = (org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package) element;
					...
					if (contentKindEnumeration != null
						&& element instanceof org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class) {
