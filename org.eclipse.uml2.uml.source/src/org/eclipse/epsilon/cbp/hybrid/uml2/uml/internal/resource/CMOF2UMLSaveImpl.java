 ...
 *
 */
package org.eclipse.epsilon.cbp.hybrid.uml2.uml.internal.resource;
	...
	public Object writeTopObjects(List<? extends EObject> contents) {
		...
		if (!toDOM) {
			...
			for (Iterator<EObject> properContents = EcoreUtil
				...
				if (eObject instanceof Property) {
				...
				} else if (eObject instanceof org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class
					...
					if (eObject instanceof org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class) {
				...
				} else if (eObject instanceof org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package) {
					org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package package_ = (org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package) eObject;
