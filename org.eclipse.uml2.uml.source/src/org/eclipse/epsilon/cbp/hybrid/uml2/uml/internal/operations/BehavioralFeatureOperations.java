 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.BehavioralFeature#validateAbstractNoMethod(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Abstract No Method</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.BehavioralFeature#createReturnResult(java.lang.String, org.eclipse.epsilon.cbp.hybrid.uml2.uml.Type) <em>Create Return Result</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.BehavioralFeature#inputParameters() <em>Input Parameters</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.BehavioralFeature#outputParameters() <em>Output Parameters</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.BehavioralFeature#isDistinguishableFrom(org.eclipse.epsilon.cbp.hybrid.uml2.uml.NamedElement, org.eclipse.epsilon.cbp.hybrid.uml2.uml.Namespace) <em>Is Distinguishable From</em>}</li>
 * </ul>
 *
 * @generated
 */
