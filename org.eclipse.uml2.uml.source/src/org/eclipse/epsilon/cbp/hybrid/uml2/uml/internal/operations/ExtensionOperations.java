 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Extension#validateNonOwnedEnd(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Non Owned End</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Extension#validateIsBinary(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Is Binary</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Extension#getStereotype() <em>Get Stereotype</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Extension#getStereotypeEnd() <em>Get Stereotype End</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Extension#isRequired() <em>Is Required</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Extension#getMetaclass() <em>Get Metaclass</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Extension#metaclassEnd() <em>Metaclass End</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExtensionOperations
	 ...
	 * @generated NOT
	 */
	public static org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class getMetaclass(Extension extension) {
		...
		if (metaclassEnd != null) {
			...
			if (type instanceof org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class) {
				return (org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class) type;
			}
		}
