 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.StateMachine#validateConnectionPoints(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Connection Points</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.StateMachine#validateClassifierContext(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Classifier Context</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.StateMachine#validateMethod(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Method</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.StateMachine#validateContextClassifier(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Context Classifier</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.StateMachine#LCA(org.eclipse.epsilon.cbp.hybrid.uml2.uml.Vertex, org.eclipse.epsilon.cbp.hybrid.uml2.uml.Vertex) <em>LCA</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.StateMachine#ancestor(org.eclipse.epsilon.cbp.hybrid.uml2.uml.Vertex, org.eclipse.epsilon.cbp.hybrid.uml2.uml.Vertex) <em>Ancestor</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.StateMachine#LCAState(org.eclipse.epsilon.cbp.hybrid.uml2.uml.Vertex, org.eclipse.epsilon.cbp.hybrid.uml2.uml.Vertex) <em>LCA State</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.StateMachine#isConsistentWith(org.eclipse.epsilon.cbp.hybrid.uml2.uml.RedefinableElement) <em>Is Consistent With</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.StateMachine#isRedefinitionContextValid(org.eclipse.epsilon.cbp.hybrid.uml2.uml.RedefinableElement) <em>Is Redefinition Context Valid</em>}</li>
 * </ul>
 *
 * @generated
 */
