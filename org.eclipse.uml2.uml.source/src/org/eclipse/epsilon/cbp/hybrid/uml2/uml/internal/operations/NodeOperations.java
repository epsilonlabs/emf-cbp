 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Node#validateInternalStructure(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Internal Structure</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Node#createCommunicationPath(boolean, org.eclipse.epsilon.cbp.hybrid.uml2.uml.AggregationKind, java.lang.String, int, int, org.eclipse.epsilon.cbp.hybrid.uml2.uml.Node, boolean, org.eclipse.epsilon.cbp.hybrid.uml2.uml.AggregationKind, java.lang.String, int, int) <em>Create Communication Path</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Node#getCommunicationPaths() <em>Get Communication Paths</em>}</li>
 * </ul>
 *
 * @generated
 */
