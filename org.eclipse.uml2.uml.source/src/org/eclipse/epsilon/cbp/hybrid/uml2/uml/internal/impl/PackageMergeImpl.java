 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.internal.impl.PackageMergeImpl#getTargets <em>Target</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.internal.impl.PackageMergeImpl#getSources <em>Source</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.internal.impl.PackageMergeImpl#getOwner <em>Owner</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.internal.impl.PackageMergeImpl#getMergedPackage <em>Merged Package</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.internal.impl.PackageMergeImpl#getReceivingPackage <em>Receiving Package</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PackageMergeImpl
	 ...
	 * @ordered
	 */
	protected org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package mergedPackage;
	 ...
	 * @generated
	 */
	public org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package getMergedPackage() {
		if (mergedPackage != null && mergedPackage.eIsProxy()) {
			InternalEObject oldMergedPackage = (InternalEObject) mergedPackage;
			mergedPackage = (org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package) eResolveProxy(
				oldMergedPackage);
	 ...
	 * @generated
	 */
	public org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package basicGetMergedPackage() {
		return mergedPackage;
	}
	...
	public void setMergedPackage(
			org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package newMergedPackage) {
		org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package oldMergedPackage = mergedPackage;
	 ...
	 * @generated
	 */
	public org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package getReceivingPackage() {
		if (eContainerFeatureID() != UMLPackage.PACKAGE_MERGE__RECEIVING_PACKAGE)
			return null;
		return (org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package) eContainer();
	}
	 ...
	 * @generated
	 */
	public org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package basicGetReceivingPackage() {
		if (eContainerFeatureID() != UMLPackage.PACKAGE_MERGE__RECEIVING_PACKAGE)
			return null;
		return (org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package) eInternalContainer();
	}
	...
	public NotificationChain basicSetReceivingPackage(
			org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package newReceivingPackage,
		...
		if (newReceivingPackage != eInternalContainer()
			...
			if (newReceivingPackage != null)
				msgs = ((InternalEObject) newReceivingPackage).eInverseAdd(this,
					...
					org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package.class, msgs);
		...
		switch (featureID) {
			...
			case UMLPackage.PACKAGE_MERGE__RECEIVING_PACKAGE :
				...
				return basicSetReceivingPackage(
					(org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package) otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case UMLPackage.PACKAGE_MERGE__OWNED_COMMENT :
				...
				return;
			case UMLPackage.PACKAGE_MERGE__MERGED_PACKAGE :
				setMergedPackage((org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package) newValue);
				return;
			case UMLPackage.PACKAGE_MERGE__RECEIVING_PACKAGE :
				setReceivingPackage((org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package) newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case UMLPackage.PACKAGE_MERGE__OWNED_COMMENT :
				...
				return;
			case UMLPackage.PACKAGE_MERGE__MERGED_PACKAGE :
				setMergedPackage((org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package) null);
				return;
			case UMLPackage.PACKAGE_MERGE__RECEIVING_PACKAGE :
				setReceivingPackage((org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package) null);
				return;
		}
	...
	public Element basicGetOwner() {
		org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package receivingPackage = basicGetReceivingPackage();
