 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Type#createAssociation(boolean, org.eclipse.epsilon.cbp.hybrid.uml2.uml.AggregationKind, java.lang.String, int, int, org.eclipse.epsilon.cbp.hybrid.uml2.uml.Type, boolean, org.eclipse.epsilon.cbp.hybrid.uml2.uml.AggregationKind, java.lang.String, int, int) <em>Create Association</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Type#getAssociations() <em>Get Associations</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Type#conformsTo(org.eclipse.epsilon.cbp.hybrid.uml2.uml.Type) <em>Conforms To</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TypeOperations
	...
	public static Operation createOwnedOperation(Type type, final String name,
		...
		Operation ownedOperation = new UMLSwitch<Operation>() {
			...
			@Override
			public Operation caseClass(org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class class_) {
