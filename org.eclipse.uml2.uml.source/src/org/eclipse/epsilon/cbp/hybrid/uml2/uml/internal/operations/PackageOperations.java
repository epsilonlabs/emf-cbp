 ...
 *
 */
package org.eclipse.epsilon.cbp.hybrid.uml2.uml.internal.operations;
...
import org.eclipse.epsilon.cbp.hybrid.uml2.uml.ProfileApplication;
...
import org.eclipse.epsilon.cbp.hybrid.uml2.uml.util.UMLUtil;
import org.eclipse.epsilon.cbp.hybrid.uml2.uml.util.UMLValidator;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package#validateElementsPublicOrPrivate(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Elements Public Or Private</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package#applyProfile(org.eclipse.epsilon.cbp.hybrid.uml2.uml.Profile) <em>Apply Profile</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package#createOwnedClass(java.lang.String, boolean) <em>Create Owned Class</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package#createOwnedEnumeration(java.lang.String) <em>Create Owned Enumeration</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package#createOwnedInterface(java.lang.String) <em>Create Owned Interface</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package#createOwnedPrimitiveType(java.lang.String) <em>Create Owned Primitive Type</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package#createOwnedStereotype(java.lang.String, boolean) <em>Create Owned Stereotype</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package#getAllAppliedProfiles() <em>Get All Applied Profiles</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package#getAllProfileApplications() <em>Get All Profile Applications</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package#getAppliedProfile(java.lang.String) <em>Get Applied Profile</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package#getAppliedProfile(java.lang.String, boolean) <em>Get Applied Profile</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package#getAppliedProfiles() <em>Get Applied Profiles</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package#getProfileApplication(org.eclipse.epsilon.cbp.hybrid.uml2.uml.Profile) <em>Get Profile Application</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package#getProfileApplication(org.eclipse.epsilon.cbp.hybrid.uml2.uml.Profile, boolean) <em>Get Profile Application</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package#isModelLibrary() <em>Is Model Library</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package#isProfileApplied(org.eclipse.epsilon.cbp.hybrid.uml2.uml.Profile) <em>Is Profile Applied</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package#unapplyProfile(org.eclipse.epsilon.cbp.hybrid.uml2.uml.Profile) <em>Unapply Profile</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package#applyProfiles(org.eclipse.emf.common.util.EList) <em>Apply Profiles</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package#allApplicableStereotypes() <em>All Applicable Stereotypes</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package#containingProfile() <em>Containing Profile</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package#makesVisible(org.eclipse.epsilon.cbp.hybrid.uml2.uml.NamedElement) <em>Makes Visible</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package#getNestedPackages() <em>Get Nested Packages</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package#getOwnedStereotypes() <em>Get Owned Stereotypes</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package#getOwnedTypes() <em>Get Owned Types</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package#visibleMembers() <em>Visible Members</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package#mustBeOwned() <em>Must Be Owned</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PackageOperations
	...
	public static boolean validateElementsPublicOrPrivate(
			org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package package_, DiagnosticChain diagnostics,
	 ...
	 * @generated NOT
	 */
	public static org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class createOwnedClass(
			org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package package_, String name,
			boolean isAbstract) {
		org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class ownedClass = (org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class) package_
	...
	public static boolean isProfileApplied(
			org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package package_, Profile profile) {
	...
	public static EList<EObject> unapplyProfile(
		...
		for (TreeIterator<EObject> allContents = getAllContents(package_, true,
			...
			if (eObject instanceof org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package) {

				for (ProfileApplication profileApplication : ((org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package) eObject)
	...
	public static EList<EObject> applyProfiles(
			org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package package_, EList<Profile> profiles) {
		...
		for (TreeIterator<EObject> allContents = getAllContents(package_, true,
			...
			if (eObject instanceof Element) {
				...
				if (element instanceof org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package) {

					for (ProfileApplication profileApplication : ((org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package) element)
						.getProfileApplications()) {
	...
	protected static EList<Stereotype> allApplicableStereotypes(
		...
		for (org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package nestedPackage : package_
			.getNestedPackages()) {
	...
	public static Profile getAppliedProfile(
			org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package package_, String qualifiedName) {
	...
	public static Profile getAppliedProfile(
		...
		if (appliedProfile == null && recurse) {
			...
			for (Iterator<org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package> otherApplyingPackages = ProfileApplicationHelper
	...
	public static EList<ProfileApplication> getAllProfileApplications(
		...
		for (org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package applyingPackage : ProfileApplicationHelper
			.getInstance(package_).getOtherApplyingPackages(package_)) {
	...
	protected static EList<org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package> getAllImportedPackages(
			org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package package_,
			EList<org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package> allImportedPackages) {

		for (PackageImport packageImport : package_.getPackageImports()) {

			if (packageImport
				.getVisibility() == VisibilityKind.PUBLIC_LITERAL) {
				org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package importedPackage = packageImport
					.getImportedPackage();
	...
	public static EList<PackageableElement> visibleMembers(
		...
		for (org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package importedPackage : getAllImportedPackages(
			package_,
	 ...
	 * @generated NOT
	 */
	public static boolean makesVisible(org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package package_,
			NamedElement el) {
	 ...
	 * @generated NOT
	 */
	public static EList<org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package> getNestedPackages(
			org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package package_) {
	 ...
	 * @generated NOT
	 */
	public static boolean mustBeOwned(org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package package_) {
		return false;
	}

	protected static boolean containsSpecializations(
			org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package package_, Classifier classifier) {
