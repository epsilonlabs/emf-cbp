 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Node#getNestedNodes <em>Nested Node</em>}</li>
 * </ul>
 *
 * @see org.eclipse.epsilon.cbp.hybrid.uml2.uml.UMLPackage#getNode()
 * @model
 * @generated
 */
public interface Node
		extends org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class, DeploymentTarget {

	/**
	 * Returns the value of the '<em><b>Nested Node</b></em>' containment reference list.
	 * The list contents are of type {@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Node}.
	 * <p>
	 ...
	 * @see org.eclipse.epsilon.cbp.hybrid.uml2.uml.UMLPackage#getNode_NestedNode()
	...
	/**
	 * Creates a new {@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Node}, with the specified '<em><b>Name</b></em>', and appends it to the '<em><b>Nested Node</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name The '<em><b>Name</b></em>' for the new {@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Node}, or <code>null</code>.
	 * @param eClass The Ecore class of the {@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Node} to create.
	 * @return The new {@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Node}.
	 * @see #getNestedNodes()
	 * @generated
	 */
	...
	/**
	 * Retrieves the first {@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Node} with the specified '<em><b>Name</b></em>' from the '<em><b>Nested Node</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name The '<em><b>Name</b></em>' of the {@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Node} to retrieve, or <code>null</code>.
	 * @return The first {@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Node} with the specified '<em><b>Name</b></em>', or <code>null</code>.
	 * @see #getNestedNodes()
	 * @generated
	 */
	 ...
	 * @param eClass The Ecore class of the {@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Node} to retrieve, or <code>null</code>.
	 * @param createOnDemand Whether to create a {@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Node} on demand if not found.
	 * @return The first {@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Node} with the specified '<em><b>Name</b></em>', or <code>null</code>.
	 * @see #getNestedNodes()
	 * @generated
	 */
