...
public class UMLDerivedUnionAdapter
	...
	protected void notifyClassChanged(Notification notification,
			EClass eClass) {
		switch (notification.getFeatureID(org.eclipse.epsilon.cbp.hybrid.uml2.uml.Class.class)) {
	...
	protected void notifyPackageChanged(Notification notification,
			EClass eClass) {
		switch (notification.getFeatureID(org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package.class)) {
