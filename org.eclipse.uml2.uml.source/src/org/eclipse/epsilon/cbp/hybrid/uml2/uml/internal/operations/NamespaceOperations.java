 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Namespace#validateMembersDistinguishable(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Members Distinguishable</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Namespace#validateCannotImportSelf(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Cannot Import Self</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Namespace#validateCannotImportOwnedMembers(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Cannot Import Owned Members</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Namespace#createElementImport(org.eclipse.epsilon.cbp.hybrid.uml2.uml.PackageableElement, org.eclipse.epsilon.cbp.hybrid.uml2.uml.VisibilityKind) <em>Create Element Import</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Namespace#createPackageImport(org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package, org.eclipse.epsilon.cbp.hybrid.uml2.uml.VisibilityKind) <em>Create Package Import</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Namespace#getImportedElements() <em>Get Imported Elements</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Namespace#getImportedPackages() <em>Get Imported Packages</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Namespace#getOwnedMembers() <em>Get Owned Members</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Namespace#excludeCollisions(org.eclipse.emf.common.util.EList) <em>Exclude Collisions</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Namespace#getNamesOfMember(org.eclipse.epsilon.cbp.hybrid.uml2.uml.NamedElement) <em>Get Names Of Member</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Namespace#importMembers(org.eclipse.emf.common.util.EList) <em>Import Members</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Namespace#getImportedMembers() <em>Get Imported Members</em>}</li>
 *   <li>{@link org.eclipse.epsilon.cbp.hybrid.uml2.uml.Namespace#membersAreDistinguishable() <em>Members Are Distinguishable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NamespaceOperations
	 ...
	 * @generated NOT
	 */
	public static EList<org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package> getImportedPackages(
			Namespace namespace) {
		EList<org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package> importedPackages = new UniqueEList.FastCompare<org.eclipse.epsilon.cbp.hybrid.uml2.uml.Package>();
