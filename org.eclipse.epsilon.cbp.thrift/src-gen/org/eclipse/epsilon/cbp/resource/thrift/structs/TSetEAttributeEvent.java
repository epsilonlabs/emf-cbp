...
public class TSetEAttributeEvent implements org.apache.thrift.TBase<TSetEAttributeEvent, TSetEAttributeEvent._Fields>, java.io.Serializable, Cloneable, Comparable<TSetEAttributeEvent> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TSetEAttributeEvent");
  ...
  static {
    schemes.put(StandardScheme.class, new TSetEAttributeEventStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TSetEAttributeEventTupleSchemeFactory());
  }
   ...
   */
  public TSetEAttributeEvent(TSetEAttributeEvent other) {
  ...
  public TSetEAttributeEvent deepCopy() {
    return new TSetEAttributeEvent(this);
  }
  ...
  public TSetEAttributeEvent setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public TSetEAttributeEvent setTarget(long target) {
    this.target = target;
    setTargetIsSet(true);
    return this;
  }
  ...
  public TSetEAttributeEvent setValues(List<String> values) {
    this.values = values;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TSetEAttributeEvent)
      return this.equals((TSetEAttributeEvent)that);
    return false;
  }

  public boolean equals(TSetEAttributeEvent that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TSetEAttributeEvent other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TSetEAttributeEvent(");
    boolean first = true;
  ...
  private static class TSetEAttributeEventStandardSchemeFactory implements SchemeFactory {
    public TSetEAttributeEventStandardScheme getScheme() {
      return new TSetEAttributeEventStandardScheme();
    }
  }

  private static class TSetEAttributeEventStandardScheme extends StandardScheme<TSetEAttributeEvent> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TSetEAttributeEvent struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TSetEAttributeEvent struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TSetEAttributeEventTupleSchemeFactory implements SchemeFactory {
    public TSetEAttributeEventTupleScheme getScheme() {
      return new TSetEAttributeEventTupleScheme();
    }
  }

  private static class TSetEAttributeEventTupleScheme extends TupleScheme<TSetEAttributeEvent> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TSetEAttributeEvent struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TSetEAttributeEvent struct) throws org.apache.thrift.TException {
