...
public class TRemoveFromResourceEvent implements org.apache.thrift.TBase<TRemoveFromResourceEvent, TRemoveFromResourceEvent._Fields>, java.io.Serializable, Cloneable, Comparable<TRemoveFromResourceEvent> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TRemoveFromResourceEvent");
  ...
  static {
    schemes.put(StandardScheme.class, new TRemoveFromResourceEventStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TRemoveFromResourceEventTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TRemoveFromResourceEvent.class, metaDataMap);
  }

  public TRemoveFromResourceEvent() {
  }
   ...
   */
  public TRemoveFromResourceEvent(TRemoveFromResourceEvent other) {
  ...
  public TRemoveFromResourceEvent deepCopy() {
    return new TRemoveFromResourceEvent(this);
  }
  ...
  public TRemoveFromResourceEvent setIds(List<Long> ids) {
    this.ids = ids;
    return this;
  }
  ...
  public TRemoveFromResourceEvent setXrefs(List<String> xrefs) {
    this.xrefs = xrefs;
    return this;
  }
  ...
  public TRemoveFromResourceEvent setPosition(int position) {
    this.position = position;
    setPositionIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TRemoveFromResourceEvent)
      return this.equals((TRemoveFromResourceEvent)that);
    return false;
  }

  public boolean equals(TRemoveFromResourceEvent that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TRemoveFromResourceEvent other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TRemoveFromResourceEvent(");
    boolean first = true;
  ...
  private static class TRemoveFromResourceEventStandardSchemeFactory implements SchemeFactory {
    public TRemoveFromResourceEventStandardScheme getScheme() {
      return new TRemoveFromResourceEventStandardScheme();
    }
  }

  private static class TRemoveFromResourceEventStandardScheme extends StandardScheme<TRemoveFromResourceEvent> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TRemoveFromResourceEvent struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.xrefs = new ArrayList<String>(_list67.size);
                for (int _i68 = 0; _i68 < _list67.size; ++_i68)
                {
                  String _elem69;
                  _elem69 = iprot.readString();
                  struct.xrefs.add(_elem69);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRemoveFromResourceEvent struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.xrefs != null) {
        oprot.writeFieldBegin(XREFS_FIELD_DESC);
        {
          ...
          for (String _iter71 : struct.xrefs)
          {
  ...
  private static class TRemoveFromResourceEventTupleSchemeFactory implements SchemeFactory {
    public TRemoveFromResourceEventTupleScheme getScheme() {
      return new TRemoveFromResourceEventTupleScheme();
    }
  }

  private static class TRemoveFromResourceEventTupleScheme extends TupleScheme<TRemoveFromResourceEvent> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TRemoveFromResourceEvent struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        oprot.writeI32(struct.ids.size());
        for (long _iter72 : struct.ids)
        {
      ...
      }
      {
        ...
        for (String _iter73 : struct.xrefs)
        {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TRemoveFromResourceEvent struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.ids = new ArrayList<Long>(_list74.size);
      ...
      struct.setIdsIsSet(true);
      {
        ...
        struct.xrefs = new ArrayList<String>(_list77.size);
        for (int _i78 = 0; _i78 < _list77.size; ++_i78)
        {
          String _elem79;
          _elem79 = iprot.readString();
          struct.xrefs.add(_elem79);
        }
      }
      struct.setXrefsIsSet(true);
      struct.position = iprot.readI32();
