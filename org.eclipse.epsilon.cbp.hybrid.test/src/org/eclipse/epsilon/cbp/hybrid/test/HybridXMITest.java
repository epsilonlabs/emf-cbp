...
public class HybridXMITest {
	...
	try {
	    ...
	    // File targetXmiFile = new
	    // File("D:\\TEMP\\ASE\\wikipedia.10187.xmi");
	    ...
	    // TEST
	    // LOADING---------------------------------------------------------------------------
	    Resource xmiResource = (new XMIResourceFactoryImpl()).createResource(URI.createFileURI(targetXmiFile.getAbsolutePath()));
		...
		xmiResource = (new XMIResourceFactoryImpl()).createResource(URI.createFileURI(targetXmiFile.getAbsolutePath()));
...
//	    File sourceCbpFile = new File("D:\\TEMP\\ASE\\bpmn2.192.cbpxml");
	...
	try {
	    ...
	    // File targetXmiFile = new
	    // File("D:\\TEMP\\ASE\\wikipedia.10187.save.xmi");
	    File targetCbpFile = new File("D:\\TEMP\\ASE\\output_save.cbpxml");
	    // File sourceCbpFile = new File("D:\\TEMP\\ASE\\bpmn2.192.cbpxml");
	    // File sourceCbpFile = new
	    // File("D:\\TEMP\\ASE\\epsilon.940.cbpxml");
	    ...
	    // HybridXMIResourceImpl(xmiResource, targetCbpBufferedStream);
	    // hybridResource.load(null);
	    // hybridResource.save(xmiOptions);
	...
	try {
	    File soundFile = new File("C:\\Program Files (x86)\\Microsoft Office\\root\\Office16\\MEDIA\\LYNC_ringtone2.wav");
