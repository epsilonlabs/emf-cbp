...
public class State2ChangeConverterTest {
	...
	private File xmiDirectory = new File("D:/TEMP/target-xmi/".replace("/", File.separator));
	private File cbpFile = new File("D:/TEMP/target-cbp/".replace("/", File.separator) + "javamodel.cbpxml");
