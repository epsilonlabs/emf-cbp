	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ConferencePackage.CONFERENCE: {
				...
				if (result == null) result = caseNode(conference);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ConferencePackage.DAY: {
				Day day = (Day)theEObject;
				T result = caseDay(day);
				if (result == null) result = caseNode(day);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConferencePackage.SLOT: {
				Slot slot = (Slot)theEObject;
				T result = caseSlot(slot);
				if (result == null) result = caseNode(slot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConferencePackage.BREAK: {
				Break break_ = (Break)theEObject;
				T result = caseBreak(break_);
				if (result == null) result = caseSlot(break_);
				if (result == null) result = caseNode(break_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConferencePackage.TRACK: {
				Track track = (Track)theEObject;
				T result = caseTrack(track);
				if (result == null) result = caseSlot(track);
				if (result == null) result = caseNode(track);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConferencePackage.TALK: {
				...
				if (result == null) result = caseNode(talk);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConferencePackage.ROOM: {
				...
				if (result == null) result = caseNode(room);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
